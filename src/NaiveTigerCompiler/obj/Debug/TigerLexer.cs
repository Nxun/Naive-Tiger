...
public partial class TigerLexer : Antlr.Runtime.Lexer
{
	...
	private void mBlockComment()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// Tiger.g3:630:13: ( '/*' ( options {greedy=false; } : ( BlockComment | . ) )* '*/' )
			DebugEnterAlt(1);
			// Tiger.g3:630:14: '/*' ( options {greedy=false; } : ( BlockComment | . ) )* '*/'
			{
			DebugLocation(630, 14);
			Match("/*"); 

			DebugLocation(630, 19);
			// Tiger.g3:630:19: ( options {greedy=false; } : ( BlockComment | . ) )*
